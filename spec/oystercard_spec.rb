    ...
    describe "#touch_in" do
      ...
      context "when balance is lower than minimum fare" do
        it "will raise an error" do
          expect { subject.touch_in(entry_station) }.to raise_error("Sorry, your card's balance isn't enough for travelling. Please top up.")
        end
      end
    end
    ...
    describe "#touch_out" do
        context "in journey" do 
          ...
          it "will save the exit station" do
            subject.touch_out(exit_station)
            current_journey = subject.journeys[-1]
            expect(current_journey.exit_station).to eq exit_station
          end
        end
    end
